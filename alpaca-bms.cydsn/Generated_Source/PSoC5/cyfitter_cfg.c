...
#define BS_UDB_1_4_0_CONFIG_VAL ((const uint8 CYFAR *)0x48000358u)
...
#define BS_IOPINS0_7_VAL ((const uint8 CYFAR *)0x480003E0u)
...
#define BS_IOPINS0_1_VAL ((const uint8 CYFAR *)0x480003F4u)

/* IOPINS0_3 Address: CYREG_PRT3_DM0 Size (bytes): 8 */
#define BS_IOPINS0_3_VAL ((const uint8 CYFAR *)0x480003FCu)

/* IOPINS0_4 Address: CYREG_PRT4_DR Size (bytes): 10 */
#define BS_IOPINS0_4_VAL ((const uint8 CYFAR *)0x48000404u)

/* CYDEV_CLKDIST_ACFG0_CFG0 Address: CYREG_CLKDIST_ACFG0_CFG0 Size (bytes): 4 */
#define BS_CYDEV_CLKDIST_ACFG0_CFG0_VAL ((const uint8 CYFAR *)0x48000410u)
...
uint8 CYXDATA * const CYCODE MUX_current__addrTable[4] = {
...
/* This is an implementation detail of the AMux. Code that depends on it may be
   incompatible with other versions of PSoC Creator. */
const uint8 CYCODE MUX_current__maskTable[4] = {
	0x80u, 0x80u, 
	0x20u, 0x20u, 
};

/*******************************************************************************
* Function Name: MUX_current_Set
********************************************************************************
* Summary:
...
*
*******************************************************************************/
void MUX_current_Set(uint8 channel)
{
	if (channel < 2)
	{
		channel += channel;
		*MUX_current__addrTable[channel] |= MUX_current__maskTable[channel];
		channel++;
		*MUX_current__addrTable[channel] |= MUX_current__maskTable[channel];
	}
}
...
/*******************************************************************************
* Function Name: MUX_current_Unset
********************************************************************************
* Summary:
...
*
*******************************************************************************/
void MUX_current_Unset(uint8 channel)
{
	if (channel < 2)
	{
		channel += channel;
		*MUX_current__addrTable[channel] &= (uint8)~MUX_current__maskTable[channel];
		channel++;
		*MUX_current__addrTable[channel] &= (uint8)~MUX_current__maskTable[channel];
	}
}
